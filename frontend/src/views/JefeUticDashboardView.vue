  ...
  <div class="layout sigta-role-layout">
    ...
    <main>
      ...
      <section v-else-if="vista==='verificacion'">
        <div class="instruction"><b>Verificar funcionamiento</b><span>Confirme si el equipo o servicio quedó operativo tras la intervención.</span></div>
        <div v-if="cargando" class="empty">Consultando tickets…</div>
        <div v-else-if="porVerificar.length" class="cards">
          <article v-for="t in porVerificar" :key="t.id">
            ...
            <div class="actions">
              <button @click="verTicket(t)">Ver detalle</button>
              <button class="reject" @click="verificarFuncionamiento(t,false)">No funciona</button>
              <button class="primary" @click="verificarFuncionamiento(t,true)">Funciona correctamente</button>
            </div>
          </article>
        </div>
      ...
      <section v-else-if="vista==='informe'">
        <div class="instruction"><b>Elaborar y validar informe final</b><span>Redacte el informe de cierre del expediente técnico.</span></div>
        <div v-if="!ticketActivo" class="cards">
